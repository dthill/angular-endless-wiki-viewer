...
let ArticleListerComponent = class ArticleListerComponent {
    constructor(getRandomArticlesService) {
...
ArticleListerComponent.ctorParameters = () => [
...
let ArticleViewerComponent = class ArticleViewerComponent {
    constructor(route, getArticleService, sanitizer) {
        this.route = route;
...
ArticleViewerComponent.ctorParameters = () => [
...
let GetArticleService = class GetArticleService {
    constructor(http) {
        this.http = http;
    }
    getArticle(title) {
...
GetArticleService.ctorParameters = () => [
...
let GetRandomArticlesService = class GetRandomArticlesService {
    constructor(http) {
        this.http = http;
        this.queryJSON = {
            action: 'query',
    ...
    getArticles() {
        const articles = this.http.get(this.createAPIurl(this.queryJSON)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(data => {
...
GetRandomArticlesService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
